#' @describeIn as_tbl_graph Method for handling phylo objects from the ape package
#' @export
...
#' @describeIn as_tbl_graph Method for handling evonet objects from the ape package
#' @export
